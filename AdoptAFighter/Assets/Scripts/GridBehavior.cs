...
public class GridBehavior : MonoBehaviour
{
    ...
    void SetPath()
    {
        ...
        else
        {
            ...
            Debug.Log("No se puede alcanzar esa localización. Estado - Visited: " + targetCellStat.visited + ", Ocupada: " + targetCellStat.Ocupada + ", Alcanzable: " + targetCellStat.movimientoalcanzable);
        ...
        switch (Personaje)
        {
            ...
            case 4:
                ...
                break;
            default:
                Debug.LogError("Personaje no válido seleccionado");
                break;
        }
    }
